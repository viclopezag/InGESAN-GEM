...
% Compute the predictive power of essential genes of a metabolic model by using a gene essentiality database and a growth rate cutoff
clc; 
%clear all;
...
% Options: 
% 'sMtb_Griffin_Cholesterol'
% 'iEK1011_Griffin_Cholesterol'
% 'iCG760_Griffin_cholesterol'
% 'iSM810_Griffin_Cholesterol'
% 'GSMN_TB_1.1_Griffin_Cholesterol'
% 'sMtb2018_Griffin_Cholesterol'

%METABOLIC_MODEL = 'iEK1011_Griffin_Cholesterol';

solverOK = changeCobraSolver('gurobi7','LP');
ZBAR_ES_Threshold = 0.9895; % ZBAR > 0.9895 ES genes  GUMBEL METHOD DE JESUS et al., 2013
ZBAR_NE_Threshold = 0.0394; % 0 < ZBAR < 0.0394 NE genes
